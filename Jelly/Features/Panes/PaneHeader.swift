...
struct PaneHeader: View {
    ...
    var body: some View {
        HStack(spacing: 6) {
            ...
            Spacer(minLength: 0)
            HStack(spacing: 0) {
                PaneHeaderButton(symbol: "rectangle.split.2x1", help: "Split Right", theme: theme, action: onSplitRight)
                PaneHeaderButton(symbol: "rectangle.split.1x2", help: "Split Down", theme: theme, action: onSplitDown)
                if isSplit {
                    PaneHeaderButton(
                ...
                PaneHeaderButton(symbol: "xmark", help: "Close Pane", theme: theme, action: onClose)
            }
